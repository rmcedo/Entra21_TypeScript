...
let animal1 = new Animal("Humano", "Rafael", 85, ["Terra", "Brasil", "SC", "Brusque"]);
let animal2 = new Animal("Gato", "Hermione", 1, ["Blumenau"]);
let animal3 = new Animal("Gato", "Luna", 0.8, ["Blumenau"]);
console.log(animal1);
...
let rafael = new Aluno("Rafael Macedo", 28, [10, 8, 9]);
console.log(rafael);
console.log("-----");
...
console.log("==========");
let daiane = new Aluno("Daiane Philippsen Maders", 27, [10, 10, 10, 8, 10, 8, 9, 9.5]);
console.log(daiane);
console.log(daiane.calcularMedia());
console.log("==========");
console.log("PROFESSOR");
let rubem = new Professor("Rubem", 33, "Java", 25, 360);
...
let vendedor1 = new Vendedor("Marcone", 42, 0.05, 67000);
